            ...
            <section id="settings" className="info">
                        ...
                        <label className="switch">
                            <input type="checkbox" id="time-format" checked={settings.longFormat}
                                onChange={(e) => onSettingsUpdate({
                                    ...
                                    duodecimalClock: document.getElementById('clock-format').checked,
                ...
                <Card>
                    ...
                    <Card.Body>
                        ...
                        <label className="switch">
                            <input type="checkbox" id="clock-format" checked={settings.duodecimalClock}
                                onChange={(e) => onSettingsUpdate({
                                    longFormat:      document.getElementById('time-format').checked,
                                    duodecimalClock: e.currentTarget.checked,
                                    soundAlarm:      document.getElementById('sound-alarm').checked
                                })}
                            ></input>
                            <span className="slider round"></span>
                        </label>
                        <span className="label">12H</span>
                    </Card.Body>
                </Card>
                <Card>
